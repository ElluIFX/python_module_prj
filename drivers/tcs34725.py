...
_REGISTER_ENABLE = int(0x00)
_REGISTER_ATIME = int(0x01)
_REGISTER_AILT = int(0x04)
_REGISTER_AIHT = int(0x06)
_REGISTER_ID = int(0x12)
_REGISTER_APERS = int(0x0C)
_REGISTER_CONTROL = int(0x0F)
_REGISTER_SENSORID = int(0x12)
_REGISTER_STATUS = int(0x13)
_REGISTER_CDATA = int(0x14)
_REGISTER_RDATA = int(0x16)
_REGISTER_GDATA = int(0x18)
_REGISTER_BDATA = int(0x1A)
_ENABLE_AIEN = int(0x10)
_ENABLE_WEN = int(0x08)
_ENABLE_AEN = int(0x02)
_ENABLE_PON = int(0x01)
_GAINS = (1, 4, 16, 60)
...
class TCS34725:
    ...
    :param int address: The I2C device address. Defaults to :int:`0x29`
    ...
    **Quickstart: Importing and using the device**
    ...
    def _read_u8(self, address: int) -> int:
        ...
        return self._bus.read_reg_byte((address | _COMMAND_BIT) & 0xFF)

    def _read_u16(self, address: int) -> int:
        # Read a 16-bit unsigned value from the specified 8-bit address.
        data = self._bus.read_reg_data((address | _COMMAND_BIT) & 0xFF, 2)
        return (data[1] << 8) | data[0]

    def _write_u8(self, address: int, val: int):
        # Write an 8-bit unsigned value to the specified 8-bit address.
        self._bus.write_reg_byte((address | _COMMAND_BIT) & 0xFF, val)
    ...
    def _write_u16(self, address: int, val: int):
        ...
        self._bus.write_reg_data((address | _COMMAND_BIT) & 0xFF, data)
