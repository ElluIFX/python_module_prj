...
class AHT20:
    ...
    def measure(self):
        ...
        while self._is_busy == 1:
            time.sleep(0.01)
        self._measure_data = self.dev.read_data(0x0, 7)
